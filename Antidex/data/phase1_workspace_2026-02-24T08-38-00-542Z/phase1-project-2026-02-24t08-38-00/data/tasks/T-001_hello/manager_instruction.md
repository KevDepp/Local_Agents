# Manager instruction â€” T-001_hello
...
- `data/tasks/T-001_hello/task.md` (this task) and this file

## Implementation
- Create `hello.txt` at the **project root**.
- Keep changes minimal: do not create extra files beyond required developer artifacts.

## Proof / verification
- Run: `Test-Path .\\hello.txt` and report the output in `dev_result.md`.

## Required task artifacts
In `data/tasks/T-001_hello/`:
