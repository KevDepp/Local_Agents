...
- `data/tasks/T-001_hello/` - Task folder for creating `hello.txt`. (owner: Manager/Dev)
- `data/tasks/T-002_world/` - Task folder for creating `world.txt`. (owner: Manager/Dev)
- `data/tasks/T-003_files/` - Task folder for creating `files.md` listing `hello.txt` and `world.txt`. (owner: Manager/Dev)
