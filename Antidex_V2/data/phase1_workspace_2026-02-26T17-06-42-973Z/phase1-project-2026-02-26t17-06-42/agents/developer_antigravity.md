...
scope: project_cwd
version: 1
updated_at: 2026-02-26T17:06:43.412Z
...
- Pendant une tache longue (browser/config), mets a jour regulierement un fichier
  ...
  - schema minimum recommande:
    - `{"updated_at":"2026-02-26T17:06:43.412Z","task_id":"<...>","stage":"reading|planning|browser|writing|done","note":"<short>","expected_silence_ms":120000}`.
...
- JSON valide, exemple minimum:
  - `{ "status":"ack", "started_at":"2026-02-26T17:06:43.412Z", "task_id":"...", "agent":"developer_antigravity" }`
