...
scope: project_cwd
version: 2
updated_at: 2026-03-10T11:41:31.050Z
...
- Pendant une tache longue (browser/config), mets a jour regulierement un fichier
  ...
  - schema minimum recommande:
    - `{"updated_at":"2026-03-10T11:41:31.050Z","task_id":"<...>","stage":"reading|planning|browser|writing|done","note":"<short>","expected_silence_ms":120000}`.
...
- JSON valide, exemple minimum:
  - `{ "status":"ack", "started_at":"2026-03-10T11:41:31.050Z", "task_id":"...", "agent":"developer_antigravity" }`
...
Tu peux utiliser Lovable dans certains cas (voir `doc/SPEC.md` section 14.4), **uniquement** si le Manager (ou l'orchestrateur) a explicitement active l'option `useLovable` pour ce run/projet, ou si l'utilisateur l'exige explicitement.
